...
class RoleSchema(ma.Schema):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'login_lockout_policy', 'login_max_attempts',
                  ...
                  'password_policy', 'password_reuse_history', 'password_reset_days',
                  'created_at', 'updated_at', 'is_admin_role', 'priority')

    # field validation
    id = fields.Integer()
    name = fields.String(
        required=True, validate=validate.Length(2, 32,
        "Value must be between 2 and 32 characters long."))
