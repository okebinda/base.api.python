...
def test_get_user_profiles_limit_5_page_2_of_3_route(app, mocker, client):
    ...
    response = client.get(
        "/user_profiles/{}/{}?app_key=123".format(expected_page,
                                                  expected_limit),
        headers={"Authorization": f"Basic {credentials}"})
...
@pytest.mark.unit
@pytest.mark.admin_api
def test_get_user_profiles_route_unauthorized(app, mocker, client):
    expected_status = 401
...
@pytest.mark.unit
@pytest.mark.admin_api
def test_get_user_profile_route_unauthorized(app, mocker, client):
    expected_status = 401
...
@pytest.mark.unit
@pytest.mark.admin_api
def test_post_user_profiles_route_unauthorized(app, mocker, client):
    expected_status = 401
...
def test_put_user_profile_route_ok(app, mocker, client):
    ...
    response = client.put(
        "/user_profile/{}?app_key=123".format(expected_m_id),
        json=data,
        headers={"Authorization": f"Basic {credentials}"})
...
@pytest.mark.unit
@pytest.mark.admin_api
def test_put_user_profile_route_unauthorized(app, mocker, client):
    expected_status = 401
    ...
    response = client.put("/user_profile/1?app_key=123")
...
@pytest.mark.unit
@pytest.mark.admin_api
def test_delete_user_profile_route_unauthorized(app, mocker, client):
    expected_status = 401
